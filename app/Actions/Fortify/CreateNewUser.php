...
class CreateNewUser implements CreatesNewUsers
{
    ...
    public function create(array $input): User
    {
        Validator::make($input, [
            ...
            // Validasi tambahan untuk data profil absen (dibuat oleh AI)
        ...
        return User::create([
            ...
            // Penyimpanan data tambahan (dihasilkan oleh AI)
            'nip' => $input['nip'] ?? null,
            ...
            // Langganan otomatis aktif selama 30 hari pertama (komentar AI)
